# -*- coding: utf-8 -*-
#
# nti.site documentation build configuration file, created by
...
version = '%s.%s.%s' % tuple(map(int, nt_ver.split('.')[:3]))
...
latex_documents = [
    (master_doc, 'ntisite.tex', u'nti.site Documentation',
...
man_pages = [
    (master_doc, 'ntisite', u'nti.site Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ntisite', u'nti.site Documentation',
     author, 'ntisite', 'One line description of project.',
     'Miscellaneous'),
]
